package fr.olympus5.externalauth;
...
import fr.olympus5.externalauth.authentication.ExternalApplicationAuthenticator;
import fr.olympus5.externalauth.authentication.ExternalApplicationAuthenticatorFactory;
import fr.olympus5.externalauth.page.ExternalActionPage;
import fr.olympus5.externalauth.page.LoginPage;
...
public class ArquillianActionTokenWithAuthenticatorTest {
    ...
    public static void setupClass() throws Exception {
        ...
        qsRealm.flows().addExecution(browserFormFlow.getDisplayName(),
                Map.of("provider", ExternalApplicationAuthenticatorFactory.ID)
        );
        ...
        AuthenticationExecutionInfoRepresentation extAppExecution = executions.stream()
                .filter(ex -> Objects.equals(ex.getProviderId(), ExternalApplicationAuthenticatorFactory.ID))
                .findFirst()
    ...
    public void testUserLogin() {
        ...
        assertThat(alice.getAttributes(), hasEntry(is(ExternalApplicationAuthenticator.DEFAULT_APPLICATION_ID + "." + "field_1"), contains("abc def")));
        assertThat(alice.getAttributes(), hasEntry(is(ExternalApplicationAuthenticator.DEFAULT_APPLICATION_ID + "." + "field_2"), contains("ghi jkl")));
    }
